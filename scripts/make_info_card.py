...
ROWS = [
    ("host",),
    ("kv", "Now", "AI/ML Fresher (seeking) - Coimbatore, TN"),
    ("kv", "Edu", "B.Tech AI & DS, KGiSL Inst. of Tech '27"),
    ("kv", "Focus", "Computer Vision . Document AI . ROS2"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "AI/ML", "TensorFlow, OpenCV, PyMuPDF, YOLOv11"),
    ("kv", "Robotics", "ROS2, Gazebo, Nav2, SLAM"),
    ("kv", "Backend", "Flask, FastAPI"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "1st place - Bonfiglioli 48hr Hackathon"),
    ("bul", "OCI Data Science Certified"),
]
